...
**Packet Analysis** — Used Wireshark and tshark to inspect captures, identify protocols, and reconstruct attacker activity from network traffic.

**Digital Forensics** — Extracted embedded files, analyzed metadata, carved artifacts from disk images, and examined malicious documents for indicators of compromise.

**Web Penetration Testing** — Inspected HTTP traffic, replayed requests with modified parameters, and identified access control weaknesses.

**Password & Hash Analysis** — Worked through hash identification, cracking workflows, and authentication artifacts using common tooling.

**Endpoint Investigation** — Analyzed suspicious process execution, examined persistence mechanisms, and worked through simulated malware behavior scenarios.

> Per NCL policy, I do not publish detailed write-ups of NCL challenge solutions. My scouting reports below reflect my participation and results.

## NCL Scouting Reports

- **Individual Scouting Report:** *(Add public share link here)*  
- **Team Scouting Report:** *(Add public share link here)*
